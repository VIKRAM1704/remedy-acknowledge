...
public class SecurityConfiguration {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http, JWTRequestFilter jwtRequestFilter,
			JWTUserDetailsService jwtUserDetailsService, JWTAuthenticationEntryPoint jwtAuthenticationEntryPoint)
			throws Exception {
		http.csrf(AbstractHttpConfigurer::disable)
				.authorizeHttpRequests(accessManagement -> accessManagement
						.requestMatchers("/login", "/register", "/swagger-ui/**", "/swagger-ui.html", "/v3/api-docs/**",
								"/v3/api-docs/swagger-config", "/swagger-ui/index.html", "/swagger-ui/swagger-ui.css",
								...
								"/swagger-ui/favicon-32x32.png", "/swagger-ui/favicon-16x16.png", "/favicon.icon")
